...
class Dimensions {
  ...
  static double headingTextSize3 = 18.00.sp;
  static double headingTextSize4 = 16.00.sp;
  static double headingTextSize5 = 14.00.sp;
  static double headingTextSize6 = 12.00.sp;
  static double headingTextSize7 = 10.00.sp;
  static double headingTextSize8 = 8.00.sp;
